...
class Reporte(models.Model):
    ...
    asignado = models.ForeignKey(Perfil,related_name=("Personas_asignadas"), on_delete=models.CASCADE)
    asignados = models.ManyToManyField(Perfil,related_name=("Personas_asignadas"))
